		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.lightdash_project_agent.test", "version", "1"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("lightdash_project_agent.test", "version", "2"),
					...
					resource.TestCheckResourceAttrSet("data.lightdash_project_agent.test", "name"),
					resource.TestCheckResourceAttrSet("data.lightdash_project_agent.test", "instruction"),
					resource.TestCheckResourceAttr("data.lightdash_project_agent.test", "version", "2"),
					resource.TestCheckResourceAttrSet("data.lightdash_project_agent.test", "updated_at"),
					resource.TestCheckResourceAttrSet("data.lightdash_project_agent.test", "created_at"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("lightdash_project_agent.test_agent", "version", "2"),
					...
					resource.TestCheckResourceAttr("lightdash_project_agent.test_agent", "enable_self_improvement", "true"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("lightdash_project_agent.minimal", "enable_data_access", "true"),
					resource.TestCheckResourceAttr("lightdash_project_agent.minimal", "enable_self_improvement", "true"),
