...
func GetOrganizationGroupsV1(c *api.Client, page float64, pageSize float64, includeMembers float64, searchQuery string) ([]GetOrganizationGroupsV1Results, error) {
