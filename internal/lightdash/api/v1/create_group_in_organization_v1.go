...
func CreateGroupInOrganizationV1(c *api.Client, organizationUuid string, groupName string, members []CreateGroupInOrganizationV1Member) (*CreateGroupInOrganizationV1Results, error) {
