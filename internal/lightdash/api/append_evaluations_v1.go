...
func (c *Client) AppendEvaluationsV1(projectUUID string, agentUUID string, evalUUID string, request AppendEvaluationsV1Request) (*AppendEvaluationsV1Results, error) {
