...
func (c *Client) UpdateProjectAccessForGroupV1(projectUuid string, groupUuid string, role models.ProjectMemberRole) (*UpdateProjectAccessForGroupResults, error) {
