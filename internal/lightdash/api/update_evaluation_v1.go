...
func (c *Client) UpdateEvaluationV1(projectUUID string, agentUUID string, evalUUID string, request UpdateEvaluationV1Request) (*UpdateEvaluationV1Results, error) {
